...
public class SalaryCalc implements ActionListener{
    ...
    public SalaryCalc(){
        ...
        //устанавлиаем  размер 250 на 300 пикселей тут можно поменять размер панели 
        ...
        //изменить цвет "Ф.И.О., Тарифная ставка,Рабочий день,Количество отработанных дней,Налоговая ставка, Чистый заработок,Премия,Подоходный налог,Сумма к выдаче" 
        //просто написать соответствующий цвет текста  строчках ниже
      ...
      //изменить цвет  "Красные поля являются обязательными для заполнения"
      //  top.setForeground(Color.GREEN));
        //изменить шрифт и размер "Красные поля являются обязательными для заполнения"
       // Font BigFontTR=new Font("TimesRoman",Font.BOLD,50);
      //  top.setFont(BigFontTR);
        //установить выравнивание по правому краю "Красные поля являются обязательными для заполнения"
       // top.setHorizontalAlignment(JLabel.RIGHT);
      //установить выравнивание по левому краю "Красные поля являются обязательными для заполнения"
       // top.setHorizontalAlignment(JLabel.LEFT);
     //изменить цвет текста кнопки Расчет
       //calc.setForeground(Color.GREEN);
       //изменить цвет текста кнопки Выход
      //  reset.setForeground(Color.GREEN);
       //изменить цвет фона кнопки Расчёт
       // calc.setBackground(Color.GREEN);
        //изменить цвет фона кнопки Выход
       //reset.setBackground(Color.GREEN); 
        //изменить размер кнопки Расчёт
      // calc.setPreferredSize(Color.GREEN);
       //изменить размер кнопки Выход
    // reset.setPreferredSize(Color.GREEN);
        //изменить шрифт и размер текста кнопки Расчёт
    //Font BigFontTR=new Font("TimesRoman",Font.BOLD,50);
  // calc.setFont(BigFontTR);
 //изменить шрифт и размер текста кнопки Выход
  // Font BigFontTR=new Font("TimesRoman",Font.BOLD,50);
 //reset.setFont(BigFontTR);
        ...
        //изменить цвет фона левой панели 
     // panelLeft.setBackground(Color.GREEN);
        //изменить цвет фона правой панели 
    ...
    public void addLabel(JComponent container, String name, Color color){
        ...
        //добавить цветную рамку в левой панели
